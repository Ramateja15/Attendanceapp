...
public class StudentActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        while (cursor.moveToNext()){
            int sid_ = cursor.getColumnIndex(DbHelper.S_ID);
            long sid = cursor.getLong(sid_);
            int roll_ = cursor.getColumnIndex(DbHelper.STUDENT_ROLL_KEY);
            int roll = cursor.getInt(roll_);
            int name_ = cursor.getColumnIndex(DbHelper.STUDENT_NAME_KEY);
